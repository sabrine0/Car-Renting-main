...
namespace Car_Renting
{
    class CarDAO : BaseDAO <Car>
    {
        ...
        {
            string sqlStr = string.Format("INSERT INTO Cars (CarName, CategoryName, Brand, Seats, PricePerDay, NumberPlate, Description) VALUES (@CarName, @CategoryName, @Brand, @Seats, @PricePerDay, @NumberPlate, @Description); SELECT SCOPE_IDENTITY()");
        ...
        {
            string sqlStr = "UPDATE Cars SET CarName = @CarName, CategoryName = @CategoryName, Brand = @Brand, Seats = @Seats, PricePerDay = @PricePerDay, NumberPlate = @NumberPlate, Description = @Description WHERE CarId = @CarId";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("@CarName", entity.CarName);
            parameters.Add("@CategoryName", entity.CategoryName);
            parameters.Add("@Brand", entity.Brand);
